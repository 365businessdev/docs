...
<div class="columns" style="margin-top: 30px; margin-bottom: 10px;">
    <div>
        ...
        <p>
            <ul class="fa-ul">
                <li><span class="fa-li"><i class="fa-duotone fa-thin fa-book" fa-lg" style="--fa-secondary-color: #00b7c3"></i></span><a href="../365-business-eric/">Über 365 business ERiC</a></li>
            </ul>
        </p>
    </div>
    <div>
        ...
        <p>
            <ul class="fa-ul">
                <li><span class="fa-li"><i class="fa-duotone fa-thin fa-book" fa-lg" style="--fa-secondary-color: #00b7c3"></i></span><a href="../365-business-pdf/">Über 365 business PDF</a></li>
            </ul>
        </p>
    </div>
    <div>
        ...
        <p>
            <ul class="fa-ul">
                <li><span class="fa-li"><i class="fa-duotone fa-thin fa-book" fa-lg" style="--fa-secondary-color: #00b7c3"></i></span><a href="../365-business-barcode/">Über 365 business Barcode</a></li>
            </ul>
        </p>
    </div>
</div>
<div class="columns" style="margin-top: 10px;">
    <div>
        ...
        <p>
            <ul class="fa-ul">
                <li><span class="fa-li"><i class="fa-duotone fa-thin fa-book" fa-lg" style="--fa-secondary-color: #00b7c3"></i></span><a href="../365-business-address-validation/">Über 365 business Address Validation</a></li>
            </ul>
        </p>
    </div>
    <div>
        ...
        <p>
            <ul class="fa-ul">
                <li><span class="fa-li"><i class="fa-duotone fa-thin fa-book" fa-lg" style="--fa-secondary-color: #00b7c3"></i></span><a href="../365-business-sanction-screen/">Über 365 business Sanction Screen</a></li>
            </ul>
        </p>
    </div>
    <div>
        ...
        <p>
            <ul class="fa-ul">
                <li><span class="fa-li"><i class="fa-duotone fa-thin fa-book" fa-lg" style="--fa-secondary-color: #00b7c3"></i></span><a href="../365-business-e-invoice/">Über 365 business E-Invoice</a></li>
            </ul>
        </p>
    </div>
</div>
