...
In diesem Abschnitt finden Sie eine Übersicht über die wichtigsten Funktionen von 365 business Banking. Da in diesem Abschnitt Funktionen aufgelistet sind, die sich in der Entwicklung befinden oder kürzlich veröffentlicht wurden, können einige Funktionen je nach Region oder Kundentyp möglicherweise nicht verfügbar sein.
...
Kernanwendungsfunktionen von 365 business Banking werden stetig weiterentwickelt und verbessert, um den sich ändernden Anforderungen der Benutzer gerecht zu werden. Wir hören unseren Partnern und Anwendern zu, um sicherzustellen, dass wir Funktionen bereitstellen, die den Bedürfnissen der Geschäftskunden entsprechen.
...
| **[Empfängerüberprüfung (VoP)](details/verification-of-payee.md)** | - | Januar 2026 |
...
Der Zahlungseingang ist ein wesentlicher Bestandteil des Finanzmanagements in Unternehmen. 365 business Banking bietet Funktionen, die den Prozess der Zahlungsabwicklung und -verfolgung optimieren.
...
| **[Verbundene Bankkonten](details/associated-bank-accounts.md)** | - | <i aria-hidden="true" class="fas fa-check" style="color: #3dd73d; font-size: larger;"></i><br>Januar 2026 |

### Zahlungsdienste 

Der Einsatz von Zahlungsdiensten (PSP) wie PayPal, Stripe und Mollie wird immer beliebter, da sie Unternehmen eine einfache und sichere Möglichkeit bieten, Zahlungen zu akzeptieren. 365 business Banking integriert diese Zahlungsdienste nahtlos in Microsoft Dynamics 365 Business Central, um den Zahlungsprozess zu optimieren und die Kundenzufriedenheit zu erhöhen.
...
| **[Klarna Integration](../payment-services/klarna.md)** | <i aria-hidden="true" class="fas fa-check" style="color: #3dd73d; font-size: larger;"></i><br>November 2025 | <i aria-hidden="true" class="fas fa-check" style="color: #3dd73d; font-size: larger;"></i><br>Januar 2026 |
...
Der Zahlungsausgang ist ein kritischer Prozess für Unternehmen, um ihre finanziellen Verpflichtungen zu erfüllen. 365 business Banking bietet Funktionen, die den Prozess der Zahlungsabwicklung und -verfolgung optimieren.
...
| **[Verarbeitung Rücklastschrift](details/return-direct-debit-processing.md)** | - | Januar 2026 |
