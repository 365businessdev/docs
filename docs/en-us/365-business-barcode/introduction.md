...
365 business Barcode uses the barcode service of the [365 business API](../365-business-api/introduction.md) and requires an active subscription after the free and non-binding trial period. The 365 business API is connected to Microsoft Dynamics 365 Business Central via the 365 business API app.
