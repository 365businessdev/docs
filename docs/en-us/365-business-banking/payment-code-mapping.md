...
<div class="alert alert-warn">
    ...
    Instead, use the <a href="bank-reconciliation-rules.md"><strong>Reconciliation Rules</strong></a> to enable more accurate mapping of bank transactions to the corresponding accounts and improve reconciliation efficiency.
</div>
