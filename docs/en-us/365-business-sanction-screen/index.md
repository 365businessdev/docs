         ...
         <span class="columns-title">Setup</span>
             <p>
                ...
                <ul class="fa-ul">
                    ...
                    <li><span class="fa-li"><i class="fa-solid fa-bolt-lightning"></i></span><a href="automated-check.md#automated-sanctions-screening-during-document-release">Set up Automated Sanction Screening on Document Release</a></li>
                </ul>
            </p>
    </div>
</div>