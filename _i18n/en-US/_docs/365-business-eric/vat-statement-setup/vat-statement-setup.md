...
> **Hinweis**<br>Wir empfehlen für die Steuerdatenart [**Antrag auf Dauerfristverlängerung**](../.lster-permanent-time-limit-extension) dieselbe MwSt.-Abrechnung, wie für die [**Umsatzsteuervoranmeldung**](../.lster-sales-vat-adv-notification) zu verwenden. Die wesentlichen Werte sind unter denselben Kennzeichen in beiden Abrechnungen vorhanden bzw. können basierend auf den Kennzeichen berechnet werden.
