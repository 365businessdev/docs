...
<div class="alert alert-notice">
    <i class="fa-solid fa-notes"></i> <strong>Gut zu wissen:</strong> Benutzer mit den folgenden Plänen sind nicht lizenzpflichtig:
    <ul>
