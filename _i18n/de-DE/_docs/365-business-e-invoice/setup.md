...
<div class="alert alert-notice">
    <i class="fa-solid fa-lightbulb"></i> <strong>Gut zu wissen:</strong>Wir empfehlen die Integration eines oder mehrerer Microsoft 365-Postfächer in Microsoft Dynamics 365 Business Central, um die automatische Verarbeitung von E-Belegen effizient zu gestalten und mit geringen Einstiegshürden zu starten.
</div>
...
<div class="alert alert-notice">
    <i class="fa-solid fa-notes"></i> <strong>Sprechen Sie uns an!</strong>Wir unterstützen Sie bei der Überprüfung Ihrer Einrichtung in Microsoft Dynamics 365 Business Central.<br>
    <br>
...
<div class="alert alert-notice">
    <i class="fa-solid fa-lightbulb"></i> <strong>Gut zu wissen:</strong>Während der Installation von 365 business E-Invoice wird ein E-Belegdienst mit dem Code <strong>365 ZUGFERD</strong> angelegt und vollständig konfiguriert.
</div>
...
<div class="alert alert-notice">
    <i class="fa-solid fa-lightbulb"></i> <strong>Gut zu wissen:</strong>Für Versand von E-Belegen werden unabhängig von der Einrichtung in der E-Invoice Einrichtung die konfigurierten E-Mail Konten gem. der E-Mail Szenarien verwendet.
</div>
...
<div class="alert alert-info">
    <i class="fa-solid fa-lightbulb"></i> <strong>Hinweis:</strong>Die Option <strong>ZUGFeRD E-Invoice Export aktivieren</strong> in der <strong>E-Invoice Einrichtung</strong> muss aktiviert sein, damit die Verkaufsrechnungen und -gutschriften automatisch in elektronische Factur-X - ZUGFeRD Dateien umgewandelt werden.
</div>

### Siehe auch

 - <a href="https://learn.microsoft.com/de-de/dynamics365/business-central/admin-how-setup-email" target="_blank">E-Mail einrichten<i class="fa-solid fa-up-right-from-square" style="font-size: x-small; vertical-align: super; margin-left: 5px;"></i></a>
 - <a href="https://learn.microsoft.com/de-de/dynamics365/business-central/across-workflow" target="_blank">Workflows in Microsoft Dynamics 365 Business Central<i class="fa-solid fa-up-right-from-square" style="font-size: x-small; vertical-align: super; margin-left: 5px;"></i></a>